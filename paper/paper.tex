...
%
We use scikit-learn's Partial Least Regression (PLS) and RidgeCV \citep{sklearn} as well as pyrcca' regularized canonical compnent analysis (RegCCA, \citep{bilenko2016pyrcca}) objects to compare B2B against the standard baselines.
