...
partial least squares) on two causal identification and prediction out of
distribution. We apply BFR to several empirical datasets to show that it
...
low-level visual factors whereas late brain responses appear to be caused
lexico-semantic factors, despite the fact that these factors covary. We finish
extending BFR to nonlinear cause-effect relationships.
\end{abstract}
