...
%
A precise characterization of this dampening, which results in a consistency proof for B2B under the presence of noise, can be found in Theorem 2 from the Supplementary Material.
