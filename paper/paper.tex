...
%
To accelerate this ensembling procedure, we implemented an efficient leave-one-out cross-validation scheme as detailed in \citep{RifkinLippert2007} % http://cbcl.mit.edu/publications/ps/MIT-CSAIL-TR-2007-025.pdf
, as follow:
%
...
% THIS NEEDS TO BE UPDATED: see de chevigner's latest paper
