...
In the next sections, we (i) describe back-and-forth regression, (ii) prove that it asymptotically extracts E, (iii) both in the linear and non linear case, and that it can be understood as a special case of canonical component analysis (cca).
%
By experimenting with simulated data, we demonstrate the robustness and typical use cases of back-and-forth regression, and show that it compares favourably with state of the art techniques for regression and feature extraction, both in terms of causal discovery and out-of-
%
Finally, we illustrate its use on an example from neuroimaging.
