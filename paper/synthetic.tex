...
%
Ridge regression [CITE], multitask Lasso [CITE], Partial Least Squares or PLS [CITE], Canonical Correlation Analysis or CCA [CITE], and Reduced Rank Regression or RRR [CITE].
%
